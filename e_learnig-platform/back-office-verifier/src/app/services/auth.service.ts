...
export class AuthService {
  ...
  private apiUrl = '/user-service/api/auth';
  // Appel SAME-ORIGIN (proxyé par le serveur Node 8086 → Keycloak 9090)
  private keycloakUrl = '/keycloak/realms/wordly-realm/protocol/openid-connect/token';
