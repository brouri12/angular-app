...
import com.elearning.quizbadge.client.HuggingFaceChatClient;
import com.elearning.quizbadge.client.OpenAiChatClient;
...
public class ChatbotService {
    ...
    private final HuggingFaceChatClient huggingFaceChatClient;
    ...
    private String askEnglishCoachAi(String message, List<ChatbotRequest.ChatMessage> history) throws Exception {
        ...
        String raw = useOpenAI
                ? openAiChatClient.chatCompletions(authHeader, jsonBody)
                : huggingFaceChatClient.chatCompletions(authHeader, jsonBody);
